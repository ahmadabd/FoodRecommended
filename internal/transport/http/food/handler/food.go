...
func (handler *handler) randomFoodHandler() echo.HandlerFunc {
...
func (handler *handler) addFoodHandler() echo.HandlerFunc {
...
func (handler *handler) allFoodsHandler() echo.HandlerFunc {
